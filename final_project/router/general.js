...
public_users.get('/',function (req, res) {
    const available_books = JSON.stringify(books, null, 4);
    return res.status(300).send(available_books);
});
...
public_users.get('/isbn/:isbn', function (req, res) {
    ...
    if (book) {
        return res.status(200).json(book); // Si el libro existe, responder con sus datos
    } else {
